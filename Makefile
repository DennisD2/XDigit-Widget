...
# ----------------------------------------------------------------------
# Makefile generated from "Imake.tmpl" and </tmp/IIf.B6uD5q>
...
# operating system:  Linux 6.12.0-160000.25-default x86_64 [ELF] (6.12.0)
# libc:	(6.40.0)
# binutils:	(1600)
...
.SUFFIXES: .cc
    ...
    CXXDEBUGFLAGS = -O2 -Wall -fno-strict-aliasing
CXXDEPENDINCLUDES =
 CXXEXTRA_DEFINES =
CXXEXTRA_INCLUDES =
  ...
  EXTRA_LIBRARIES =
   ...
   PARALLELMFLAGS =
    ...
    INSTKMEMFLAGS = -m 4711
      ...
      CDEBUGFLAGS = -O2 -Wall -fno-strict-aliasing
        CCOPTIONS =
...
# DO NOT DELETE
Digit.o: Digit.c /usr/include/stdc-predef.h /usr/include/stdio.h \
 ...
 /usr/include/bits/iscanonical.h /usr/include/X11/IntrinsicP.h \
 ...
 /usr/include/X11/StringDefs.h DigitP.h Digit.h
