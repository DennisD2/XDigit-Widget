...
# ----------------------------------------------------------------------
# Makefile generated from "Imake.tmpl" and </tmp/IIf.twWnF6>
...
CFLAGS += -std=c17
CDEBUGFLAGS=-g
SYS_LIBRARIES = -lXext -lXm -lXmu -lXt -lX11
...
LOCAL_LIBRARIES =
  EXTRA_DEFINES =
        DEPLIBS = $(DEPXLIB)
SYS_LIBRARIES   = -lVideo -lXt $(XLIB) -lc

PROGRAM       	= libVideo.a xdigit
...
libVideo.a: $(OBJS) $(EXTRALIBRARYDEPS)
	$(RM) $@
	$(AR) $@ $(OBJS)
	$(RANLIB) $@
	$(_NULLCMD_)
...
dist::
	-for i in $(SRCS) $(SRCS1) $(SRCS2) $(SRCS3) Imakefile  ; do \
	( cd $(ROOT) ; \
