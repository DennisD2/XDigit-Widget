...
# ----------------------------------------------------------------------
# Makefile generated from "Imake.tmpl" and </tmp/IIf.Rqz42x>
...
# platform:  $XFree86: xc/config/cf/OpenBSD.cf,v 3.100 2004/01/08 22:51:41 herrb Exp $
# $XdotOrg: xc/config/cf/OpenBSD.cf,v 1.11 2005/06/15 20:03:51 idr Exp $
#
# operating system:  OpenBSD 7.8 sparc64 OSBinaryType (7.8.0)
...
# $OpenBSD: OpenBSDLib.rules,v 1.1 2000/10/09 20:43:58 matthieu Exp $

# $XFree86: xc/config/cf/OpenBSDLib.rules,v 1.10 2003/10/31 20:49:03 herrb Exp $
       ...
       CXXDEFINES = $(CXXINCLUDES) $(CXXSTD_DEFINES) $(THREADS_CXXDEFINES) $(DEFINES) $(CXXEXTRA_DEFINES)
         ...
         COMPRESS = compress
          GZIPCMD = gzip -n
           ...
           RAWCPP = /usr/libexec/cpp -undef $(STD_CPP_OPTIONS)
 ...
 EXTRA_LOAD_FLAGS = -Wl,-rpath,$(USRLIBDIRPATH)
  ...
  EXTRA_LIBRARIES =
   ...
   PARALLELMFLAGS =
    SHAREDCODEDEF =
         SHLIBDEF =
     SHLIBLDFLAGS = -shared -fPIC -Wl,-rpath,$(USRLIBDIRPATH) $(SHLIBGLOBALSFLAGS)
         NOSTDLIB = -nostdlib
...
# platform:	$OpenBSD: OpenBSDLib.tmpl,v 1.6 2003/04/04 19:48:58 matthieu Exp $
# platform: $XFree86: xc/config/cf/OpenBSDLib.tmpl,v 1.10 2004/06/29 22:57:46 herrb Exp $
#
...
libWidgets.a: $(OBJS) $(EXTRALIBRARYDEPS)
	$(RM) $@
	$(AR) $@ $(OBJS)
	$(RANLIB) $@
	$(_NULLCMD_)
...
dist::
	-for i in $(SRCS) $(SRCS1) widgets.tmpl Imakefile  ; do \
	( cd $(ROOT) ; \
	  tar ruvf $(DIST_TAR_FILE) ./$$i ; \
	); \
	done
...
cleandir::
	$(RM) *.CKP *.ln *.BAK *.bak *.o core errs ,* *~ *.a .emacs_* tags TAGS make.log MakeOut *.core grohtml*.png *-auto-*.png "#"*
